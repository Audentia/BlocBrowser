...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Welcome!", @"Welcome title") message:NSLocalizedString(@"Hey bro, enjoy the surf", @"Welcome comment") delegate:nil cancelButtonTitle:NSLocalizedString(@"Surf on!", @"dismiss button title") otherButtonTitles:nil];
    [alert show];
}
